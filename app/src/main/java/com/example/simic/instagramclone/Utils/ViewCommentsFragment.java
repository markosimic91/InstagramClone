...
public class ViewCommentsFragment extends Fragment {
    ...
    @BindView(R.id.ivPostComment) ImageView mCheckMark;
    @BindView(R.id.comment) EditText mComment;
    @BindView(R.id.listComments) ListView mListView;
                        ...
                        query.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                for (DataSnapshot singleSnapshot : dataSnapshot.getChildren()){
                                    ...
                                    for (DataSnapshot dSnapshot : singleSnapshot.child(getString(R.string.field_comments))
                                            .getChildren()){
                                        Like like = new Like();
